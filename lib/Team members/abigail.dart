...
class Abigail extends StatefulWidget {
  const Abigail({super.key});

  @override
  State<Abigail> createState() => _AbigailState();
}

class _AbigailState extends State<Abigail> {
  @override
        ...
        child: Flexible(
          child: Container(
            child: Padding(
              ...
              child: Wrap(
                children: [
                  Text(Team_constants.text7, style: GoogleFonts.abel(fontWeight: FontWeight.bold, fontSize: 34),),
                  Text(Team_constants.text50, style: GoogleFonts.abel( fontSize: 18)),
                  Text(Team_constants.text51, style: GoogleFonts.abel( fontSize: 18)),
                  Text(Team_constants.text52, style: GoogleFonts.abel(fontSize: 18)),
                  Text(Team_constants.text53, style: GoogleFonts.abel(fontSize: 18)),
                  Text(Team_constants.text54, style: GoogleFonts.abel(fontSize: 18)),
                  SizedBox(height: 40,),
                  Desktop_Footer()
                ],
              ),
