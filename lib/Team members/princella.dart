...
import '../route.dart';
class Princella extends StatefulWidget {
  const Princella({super.key});

  @override
  State<Princella> createState() => _PrincellaState();
}

class _PrincellaState extends State<Princella> {
  @override
        ...
        child: Flexible(
          child: Container(
            child: Padding(
              ...
              child: Wrap(
                children: [
                  Text(Team_constants.text11, style: GoogleFonts.abel(fontWeight: FontWeight.bold, fontSize: 34),),
                  Text(Team_constants.text63, style: GoogleFonts.abel( fontSize: 18)),
                  Text(Team_constants.text64, style: GoogleFonts.abel( fontSize: 18)),
                  Text(Team_constants.text65, style: GoogleFonts.abel(fontSize: 18)),
                  Text(Team_constants.text66, style: GoogleFonts.abel(fontSize: 18)),
                  Text(Team_constants.text67, style: GoogleFonts.abel(fontSize: 18)),
                  SizedBox(height: 40,),
                  Desktop_Footer(),
                ],
              ),
