...
class Belinda extends StatefulWidget {
  const Belinda({super.key});

  @override
  State<Belinda> createState() => _BelindaState();
}

class _BelindaState extends State<Belinda> {
  @override
        ...
        child: Flexible(
          child: Container(
            child: Padding(
              ...
              child: Wrap(
                children: [
                  Text(Team_constants.text23, style: GoogleFonts.abel(fontWeight: FontWeight.bold, fontSize: 34),),
                  Text(Team_constants.text94, style: GoogleFonts.abel( fontSize: 18)),
                  Text(Team_constants.text95, style: GoogleFonts.abel( fontSize: 18)),
                  SizedBox(height: 40,),
                  Desktop_Footer()
                ],
              ),
